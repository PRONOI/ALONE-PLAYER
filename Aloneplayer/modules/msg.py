...
import os
from Aloneplayer.config import SOURCE_CODE,ASSISTANT_NAME,PROJECT_NAME,SUPPORT_GROUP,UPDATES_CHANNEL
class Messages():
      START_MSG = "**👋 Ɦɘɭɭø [{}](tg://user?id={}),**\n\n**🤖 Ɩ ƛɱ ƛɳ Ʌɗⱱɑɳƈɘɗ Ƥɤɘɱɩʋɱ Ɱʋsɩƈ Ƥɭɑƴɘɤ Ɓøʈ Ƈɤɘɑʈɘɗ Ɓƴ [ɅɭøƝɘ](t.me/ALONExBOY) ƒøɤ Ƥɭɑƴɩɳʛ Ɱʋsɩƈ ɩɳ Ƭɘɭɘʛɤɑɱ Ƈɦɑɳɳɘɭs & Ɠɤøʋƥs.**\n\n**✅ Sɘɳɗ Ɱɘ /help ƒøɤ Ɱøɤɘ Ɩɳƒø ...**"
      HELP_MSG = [
        ".",
f"""
